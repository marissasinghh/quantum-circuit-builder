    ...
    <div className="flex flex-1 min-h-0 w-full h-full">
      ...
      >
        <div className="flex-1 w-full min-w-0 flex flex-col sm:flex-row sm:min-h-0 sm:h-full overflow-y-auto sm:overflow-y-hidden">
          ...
          <aside
            className="w-full sm:w-auto sm:shrink sm:basis-[523px] sm:min-w-[320px] bg-bg-sidebar border-t sm:border-t-0 sm:border-l border-tier1 p-3 sm:overflow-y-auto flex flex-col gap-0 min-h-0 sm:h-full"
          >
